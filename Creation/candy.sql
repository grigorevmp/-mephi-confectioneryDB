...
(
    ...
    RentCost decimal(9,2) NOT NULL CHECK (RentCost > 0.0)
);
...
(
    ...
    Emp_Position character varying(50) NOT NULL CHECK (Emp_Position IN ('Шеф-Кондитер',
    	'Кондитер', 'Кассир', 'Курьер', 'Владелец')),
    BaseRate decimal(8,2) NOT NULL CHECK (BaseRate > 0.00),
...
(
    Article character varying(50) NOT NULL PRIMARY KEY ,
    idConfectionary integer NOT NULL,
    Name character varying(50) NOT NULL,
    ShortDescription character varying(100),
    Amount integer NOT NULL CHECK (Amount >= 0),
    Cost decimal(8, 2) NOT NULL CHECK (Cost > 0.00),
    FOREIGN KEY (idConfectionary)
        REFERENCES Confectionary (idConfectionary) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE RESTRICT
...
(
    idStore integer NOT NULL,
    Artice character varying(50) NOT NULL,
    Cost decimal(8, 2) NOT NULL CHECK (Cost > 0.00),
...
(
    ...
    ClientSecondName character varying(50),
...
(
    ...
    CookingTime character varying(50) NOT NULL,
...
(
    ...
    EffectPercent decimal(5, 2) NOT NULL CHECK (EffectPercent BETWEEN 0.00 AND 100.00),
